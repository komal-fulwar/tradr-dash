...
$(window).on('load', function () {
  ...
  var $supportTrackerCharttwo = document.querySelector('#support-trackers-chart2');
  ...
  var supportTrackerCharttwoOptions;
  ...
  supportTrackerCharttwo = new ApexCharts($supportTrackerCharttwo, supportTrackerCharttwoOptions);
  supportTrackerCharttwo.render();
